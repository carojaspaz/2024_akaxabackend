...
export class GetAllOperatorTeachingProfilesController extends BaseController{        
    /**
     *
     */
    ...
    async executeImpl(): Promise<any> {        
        try{            
            const result = await this.profileService.GetAllOperatorsByType(profileTypesName.Teaching) as any;
            if(result.isLeft()) {
