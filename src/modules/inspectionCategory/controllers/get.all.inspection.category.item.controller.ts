...
export class GetAllItemsInspectionCategoryController extends BaseController{        
    /**
     *
     */
    ...
    async executeImpl(): Promise<any> {                
        try{                                         
            const result = await this.inspectionCategoryService.GetAllCategoryItems() as any
            if(result.isLeft()) {
