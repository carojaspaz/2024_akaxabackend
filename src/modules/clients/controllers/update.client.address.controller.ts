import { BaseController, GenericAppError, AddressDto } from '../../../core';
import { ClientService } from '../services/client.service';
import { ClientErrors } from '../repository';

export class UpdateClientAddressController extends BaseController{        
    /**
     *
     */
    ...
    async executeImpl(): Promise<any> {                
        try{                        
            ...
            const result = await this.clientService.AddUpdateAddress(id, dto) as any
            if(result.isLeft()) {
