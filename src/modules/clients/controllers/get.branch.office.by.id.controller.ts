...
export class GetBranchByIdController extends BaseController{        
    /**
     *
     */
    ...
    async executeImpl(): Promise<any> {                
        try{                        
            const id = this.req.params.idBranch
            const result = await this.clientService.GetBranchOfficeById(id) as any
            if(result.isLeft()) {
